...
gene_medians = vec(median(data.expr, dims=2))
norm_expr = data.expr ./ gene_medians
...
save_dir = "/home/golem/scratch/chans/lincsv2/plots/trt/norm_infographs/"
